...
function fnapgmController()
	...
	if game.GetMap()=="fnap_scc" then
		...
		AnimatronicsControllerGUI.FluttershyBtn = vgui.Create( "DButton" )
		AnimatronicsControllerGUI.FluttershyBtn:SetParent(AnimatronicsControllerGUI.Fluttershy)
		AnimatronicsControllerGUI.FluttershyBtn:SetPos( 0, 0 )
		AnimatronicsControllerGUI.FluttershyBtn:SetSize( 128, 32 )
		AnimatronicsControllerGUI.FluttershyBtn:SetText("TAUNT")
		AnimatronicsControllerGUI.FluttershyBtn:SetFont("FNAFGMNIGHT")
		AnimatronicsControllerGUI.FluttershyBtn:SetTextColor( Color( 255, 255, 255, 255 ) )
		AnimatronicsControllerGUI.FluttershyBtn.DoClick = function( button )
			GAMEMODE:AnimatronicTaunt(12)
		end
		AnimatronicsControllerGUI.FluttershyBtn.Paint = function( self, w, h )
			draw.RoundedBox( 0, 0, 0, w, h, Color( 0, 0, 0, 220 ) )
			surface.SetDrawColor( 255, 255, 255, 255 )
			surface.DrawOutlinedRect( 0, 0, w, h )
		end
		...
		AnimatronicsControllerGUI.TwilightBtn = vgui.Create( "DButton" )
		AnimatronicsControllerGUI.TwilightBtn:SetParent(AnimatronicsControllerGUI.Twilight)
		AnimatronicsControllerGUI.TwilightBtn:SetPos( 0, 0 )
		AnimatronicsControllerGUI.TwilightBtn:SetSize( 128, 32 )
		AnimatronicsControllerGUI.TwilightBtn:SetText("TAUNT")
		AnimatronicsControllerGUI.TwilightBtn:SetFont("FNAFGMNIGHT")
		AnimatronicsControllerGUI.TwilightBtn:SetTextColor( Color( 255, 255, 255, 255 ) )
		AnimatronicsControllerGUI.TwilightBtn.DoClick = function( button )
			GAMEMODE:AnimatronicTaunt(13)
		end
		AnimatronicsControllerGUI.TwilightBtn.Paint = function( self, w, h )
			draw.RoundedBox( 0, 0, 0, w, h, Color( 0, 0, 0, 220 ) )
			surface.SetDrawColor( 255, 255, 255, 255 )
			surface.DrawOutlinedRect( 0, 0, w, h )
		end
		...
		AnimatronicsControllerGUI.RarityBtn = vgui.Create( "DButton" )
		AnimatronicsControllerGUI.RarityBtn:SetParent(AnimatronicsControllerGUI.Rarity)
		AnimatronicsControllerGUI.RarityBtn:SetPos( 0, 0 )
		AnimatronicsControllerGUI.RarityBtn:SetSize( 128, 32 )
		AnimatronicsControllerGUI.RarityBtn:SetText("TAUNT")
		AnimatronicsControllerGUI.RarityBtn:SetFont("FNAFGMNIGHT")
		AnimatronicsControllerGUI.RarityBtn:SetTextColor( Color( 255, 255, 255, 255 ) )
		AnimatronicsControllerGUI.RarityBtn.DoClick = function( button )
			GAMEMODE:AnimatronicTaunt(14)
		end
		AnimatronicsControllerGUI.RarityBtn.Paint = function( self, w, h )
			draw.RoundedBox( 0, 0, 0, w, h, Color( 0, 0, 0, 220 ) )
			surface.SetDrawColor( 255, 255, 255, 255 )
			surface.DrawOutlinedRect( 0, 0, w, h )
		end
